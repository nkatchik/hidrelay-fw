...
#define HID_TRANSPORT_BT_ADDR_LE_PUBLIC_IDENTITY 4U
#define HID_TRANSPORT_BT_ADDR_LE_RANDOM_IDENTITY 5U
...
#define HID_TRANSPORT_RECONNECT_RESULT_PAIRING_CLASSIC_CONNECT_FAILED 8U
#define HID_TRANSPORT_RECONNECT_RESULT_PAIRING_LE_CONNECT_FAILED 9U
#define HID_TRANSPORT_RECONNECT_RESULT_PAIRING_LE_HIDS_FAILED 10U
...
typedef enum {
    ...
    HID_TRANSPORT_BT_ADDR_TYPE_LE_PUBLIC_IDENTITY = HID_TRANSPORT_BT_ADDR_LE_PUBLIC_IDENTITY,
    HID_TRANSPORT_BT_ADDR_TYPE_LE_RANDOM_IDENTITY = HID_TRANSPORT_BT_ADDR_LE_RANDOM_IDENTITY
